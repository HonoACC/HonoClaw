...
export const PROVIDER_DEFINITIONS: ProviderDefinition[] = [
  ...
  },
  {
    ...
    model: 'GPT',
    requiresApiKey: true,
    defaultBaseUrl: 'http://api.honoacc.com',
    showBaseUrl: true,
    showModelId: true,
    defaultModelId: 'gpt-5.4',
    modelIdPlaceholder: 'gpt-5.4',
    apiKeyUrl: 'http://api.honoacc.com',
    category: 'compatible',
    envVar: 'HONOAPI_API_KEY',
    supportedAuthModes: ['api_key'],
    defaultAuthMode: 'api_key',
    supportsMultipleAccounts: true,
    providerConfig: {
      baseUrl: 'http://api.honoacc.com',
      api: 'openai-completions',
      apiKeyEnv: 'HONOAPI_API_KEY',
    },
  },
  {
    id: 'honoapi-cn',
    ...
    model: 'GPT',
    requiresApiKey: true,
    defaultBaseUrl: 'http://cn-api.honoacc.com',
    showBaseUrl: true,
    showModelId: true,
    defaultModelId: 'gpt-5.4',
    modelIdPlaceholder: 'gpt-5.4',
    apiKeyUrl: 'http://api.honoacc.com',
    category: 'compatible',
    envVar: 'HONOAPI_CN_API_KEY',
    supportedAuthModes: ['api_key'],
    defaultAuthMode: 'api_key',
    supportsMultipleAccounts: true,
    providerConfig: {
      baseUrl: 'http://cn-api.honoacc.com',
      api: 'openai-completions',
      apiKeyEnv: 'HONOAPI_CN_API_KEY',
    },
  },
  {
    id: 'modelstudio',
